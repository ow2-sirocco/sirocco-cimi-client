...
public class Client {
    ...
    private static Command commands[] = {new MachineCreateCommand(), new MachineShowCommand(), new MachineListCommand(),
        ...
        new MachineCaptureCommand(), new MachineVolumeCreateCommand(), new MachineVolumeDeleteCommand(),
        new MachineVolumeListCommand(), new MachineVolumeShowCommand(), new DiskListCommand(), new DiskShowCommand(),
        new MachineNetworkInterfaceListCommand(), new MachineNetworkInterfaceShowCommand(), new MachineImageCreateCommand(),
        new MachineImageUpdateCommand(), new MachineImageShowCommand(), new MachineImageListCommand(),
        new MachineImageDeleteCommand(), new MachineConfigCreateCommand(), new MachineConfigUpdateCommand(),
        new MachineConfigShowCommand(), new MachineConfigListCommand(), new MachineConfigDeleteCommand(),
        new MachineTemplateCreateCommand(), new MachineTemplateShowCommand(), new MachineTemplateListCommand(),
        new MachineTemplateDeleteCommand(), new MachineTemplateUpdateCommand(), new JobListCommand(), new JobShowCommand(),
